    ...
    \begin{frame}{Distribution of Work}
        ...
        \begin{itemize}
            ...
            \begin{description}
                ...
                \pause \item[msp] additional method (Replica Set Initialization)
                ...
                \pause \item[master] ORM layer problems, prioritization datastructures
            \end{description}
        \end{itemize}
    ...
    \begin{frame}{Lessons Learned}
      ...
      \begin{itemize}
        ...
        \item<+-> \texttt{gorm} shortcomings
          \begin{itemize}
            \item<+-> foreign key support $\rightarrow$ ugly hacks \pnote{mention no ON DELETE CASCADE} 
       ...
       \item<+-> Replica Set Configuration TODO flowchart
         \begin{itemize}
           ...
           \item<+-> $\rightarrow$ global coordination in master
                   \pnote{does not fit with originla architecture, had to extend MSP \& deployer for this special case, leaky abstractions}
         \end{itemize}
      \end{itemize}

    \end{frame}
    \begin{frame}{Lessons Learned}
      \pnote{explain states in the graphics, from replica set created to running, including recovering phase}
      \missingfigure[figwidth=\linewidth]{vertical DOT graph of replica set states}
    \end{frame}
    \begin{frame}{Lessons Learned}
