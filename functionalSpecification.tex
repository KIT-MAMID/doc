...
}
{
	\begin{itemize}
		...
		% TODO add step of adding a host to a risk group
	\end{itemize}
}
...
{
	\begin{itemize}
		\item %TODO. Sharding config server setting is not modifiable.
	\end{itemize}
}
...
\testsequence
[\ref{F:gui_crud_inventory}, \ref{F:gui_set_slave_type}, \ref{F:gui_set_root_data_dir}]
{
}
{
	\begin{itemize}
		\item %TODO. If you don't know what to test here, walk through the functional requirements referenced above.
	\end{itemize}
}

\oitem{TS}{} Add Risk Group
\testsequence
[\ref{F:gui_set_risk_groups}]
{
}
{
	\begin{itemize}
