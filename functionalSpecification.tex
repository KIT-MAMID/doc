...
% inventory ops -> slave
\oitem{MK}{available_slave_modes} The \gls{administrator} can set a \gls{slave} in the \gls{inventory} to one of the following modes: \gls{active mode}, \gls{maintenance mode}, \gls{disabled mode}.
...
\begin{description}
	...
	\oitem{F}{gui_set_slave_mode} Set mode of \gls{host} (\ref{MK:available_slave_modes}).
...
\begin{description}
	...
	\oitem{WF}{cli_set_slave_mode} Set mode of \gls{host} (\ref{MK:available_slave_modes}).
