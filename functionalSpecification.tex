...
}
{
	\begin{itemize}
		...
		\item The \hyperref[SM:GUI]{GUI} prompts the \gls{administrator} for confirmation (\ref{subsec:ui:remove_replica_set}). %TODO missing functional requirement
		\item The \gls{administrator} confirms the removal by clicking the confirmation prompt's \textit{remove button}.
