...
\end{figure}
The overview page presents an overview of the current cluster state.
\begin{itemize}
	\uiel{Current Problems}{section}{shows an rough insight of current slave problems and replica set problems}
	\uiel{Slave States}{section}{displays a statistic of the current distribution of slave states in the cluster}
\end{itemize}
...
\end{figure}
The slaves page enables the admin to inspect and manage all slaves.
\begin{itemize}
	\uiel{Unknown}{section}{shows all slaves in unknown state}
	\uiel{Disabled}{section}{shows all disabled slaves}
	\uiel{Active}{section}{shows all active slaves}
	\uiel{Edit}{button}{edit the slave in view \ref{subsec:ui:modify_slave}}
\end{itemize}
...
\end{figure}
The replica sets page enables the admin to inspect and manage all replica sets.
\begin{itemize}
	\uiel{Degraded}{section}{shows all degraded replica sets}
	\uiel{Disabled}{section}{shows all active replica sets}
	\uiel{Edit}{button}{edit the rpelica set in view \ref{subsec:ui:modify_replica_set}}
\end{itemize}
\begin{figure}[H]
	\centering
...
\end{figure}
\subsection{Modifying a Slave}\label{subsec:ui:modify_slave}
\begin{figure}[H]
	\centering
...
\subsection{Modifying a Replica Set}\label{subsec:ui:modify_replica_set}
\begin{figure}[H]
	\centering
