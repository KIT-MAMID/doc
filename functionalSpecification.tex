...
\begin{itemize}
	...
	\end{itemize}
	\uiel{Create}{button}{Click to create a new risk group with the (unique) name of textfield's contents at the left.}
\end{itemize}
\begin{figure}[H]
	\centering
...
}
{
	\begin{itemize}
		...
		\item The \gls{administrator} confirms removal of $G$ by clicking the \textit{confirmation button}.
