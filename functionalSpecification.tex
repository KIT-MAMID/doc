...
\end{figure}
In the \textit{Slave View}, the user can remove the slave the inventory by clicking the red \textit{Remove Slave} button (\ref{F:gui_crud_inventory}, \ref{F:gui_crud_inventory_confirm_removal}).
