...
\NewDocumentCommand{\refproperty}{m}{
...
\NewDocumentCommand{\refgoparam}{m}{ %TODO: Deprecated - use refparam
	\refparam{#1}
}
...
\include{demo_helpers}
\include{master_slave_protocol}
\include{slave}
\include{master}
\include{master_api}
\include{gui}
\include{notification_manager}
