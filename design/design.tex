...
\NewDocumentCommand{\gotype}{m m g g}{
  \subsection{#1}
  #2
  \IfValueT{#4}{
...
\NewDocumentCommand{\struct}{m m g g}{\gotype{Struct \codeinline{#1}}{#2}{#4}{#3}}
\newcommand{\interface}[3]{\gotype{Interface \codeinline{#1}}{#2}{#3}}

\NewDocumentCommand{\property}{m o +m}{
\item{\codeinline{#1\hspace{0.1cm}:\hspace{0.1cm}#2}\\#3}
}
\NewDocumentCommand{\method}{m o d() +m}{
\item{\codeinline{#1(\IfValueT{#3}{$\cdot$})\IfValueT{#2}{\hspace{0.1cm}:\hspace{0.1cm}#2}}}
  \IfValueT{#3}{
    \begin{description}
