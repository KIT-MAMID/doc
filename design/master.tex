...
\struct{Slave}{
  ...
  \property{MongodPortRangeBegin}[uint]{Beginning of the range of ports \reftype{Mongod} spawned by the slave may listen on (inclusive).}
  \property{MongodPortRangeEnd}[uint]{End of the range of ports \reftype{Mongod} spawned by the slave may listen on (exclusive).
