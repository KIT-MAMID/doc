...
We start with the removal of superflous Replica Set members.\\
...
Given \ref{alg:EffectiveMemberCount}, we can now proceed with removal of superflous Replica Set members.
...
It is crucial to the implementation of \ref{alg:addmongods} that Mongods in \refgo{model.MongodExecutionState.Recovering}
\begin{itemize}
