...
\struct{Mongod}{
  ...
  \property{LastEstablishStateError}[*\reftype{SlaveError}]{The last \reftype{SlaveError} created upon executing \refgo{msp.Consumer.EstablishMongodState}.\\
...
\struct{CommunicationError}{
  Description of an error generated on the \refgo{msp.Client} side in case it cannot communicate properly with the \refgo{slave},
