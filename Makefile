...
CUTYCAPT=$(XVFB_RUN) $(CUTYCAPT_BIN) --zoom=1.25 --min-width=1600 --min-height=1200  --user-style-string="html, body { max-height: 1200px; overflow: hidden;}" --url=$(SCREENSHOTS_BASE_URL)$(1) --out=$(2)
